...
def my_main(part, assignment_solution_folder, student_solution_folder):
    ...
    if ((part == 1) or (part == 2) or (part == 3) or (part == 4) or (part == 5)):
...
if __name__ == '__main__':
    ...
    assignment_solution_folder = "./Assignment_Solutions/A02_Part" + str(part) + "/"
    student_solution_folder = "./Student_Attempts/A02_Part" + str(part) + "/"
